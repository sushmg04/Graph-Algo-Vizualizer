...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        # Algorithm Names
        self.algorithm = ['Linear Search', 'Binary Search', 'BFS DFS']
        ...
        #self.add_element = Entry(self.frame1, width=24, bd=3, bg='light pink')
        #self.add_element.insert(END, 'Enter an element to add')
        ##self.add_element.pack_propagate(0)
        #self.add_element.place(relx=0.22, rely=0.32)
        ...
        #self.frame_btn3 = Frame(self.frame1, width=230, height=40, bg="light salmon")
        #self.frame_btn3.grid_propagate(0)
        #self.frame_btn3.place(relx=0.0, rely=0.36)
        ...
        #self.btn_sort = Button(self.frame_btn3, text="add", padx=13, pady=3, command=self.zatu(self.add_element().get()),
        #                      bg="RoyalBlue3", fg="azure", cursor="hand2")
        #self.btn_sort.place(relx=0.42, rely=0)
